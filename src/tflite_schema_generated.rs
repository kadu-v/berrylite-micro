...
pub mod tflite {
    ...
    impl<'a> Operator<'a> {
        ...
        pub fn custom_options_offset(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(Operator::VT_CUSTOM_OPTIONS_OFFSET, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn custom_options_size(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(Operator::VT_CUSTOM_OPTIONS_SIZE, Some(0))
                    .unwrap()
            }
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> OperatorBuilder<'a, 'b> {
        ...
        pub fn add_custom_options_size(&mut self, custom_options_size: u64) {
            self.fbb_
                .push_slot::<u64>(Operator::VT_CUSTOM_OPTIONS_SIZE, custom_options_size, 0);
        }
        #[inline]
