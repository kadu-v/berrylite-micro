...
impl<'a> Operator<'a> {
  ...
  pub const VT_CUSTOM_OPTIONS_OFFSET: flatbuffers::VOffsetT = 22;
  pub const VT_CUSTOM_OPTIONS_SIZE: flatbuffers::VOffsetT = 24;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    builder.add_custom_options_size(args.custom_options_size);
    builder.add_custom_options_offset(args.custom_options_offset);
  ...
  pub fn custom_options_offset(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Operator::VT_CUSTOM_OPTIONS_OFFSET, Some(0)).unwrap()}
  }
  #[inline]
  pub fn custom_options_size(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Operator::VT_CUSTOM_OPTIONS_SIZE, Some(0)).unwrap()}
  }
  #[inline]
  #[allow(non_snake_case)]
...
impl<'a: 'b, 'b> OperatorBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_custom_options_offset(&mut self, custom_options_offset: u64) {
    self.fbb_.push_slot::<u64>(Operator::VT_CUSTOM_OPTIONS_OFFSET, custom_options_offset, 0);
  }
  #[inline]
  pub fn add_custom_options_size(&mut self, custom_options_size: u64) {
    self.fbb_.push_slot::<u64>(Operator::VT_CUSTOM_OPTIONS_SIZE, custom_options_size, 0);
  }
  #[inline]
...
impl core::fmt::Debug for Operator<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("Operator");
      ...
      ds.field("custom_options_offset", &self.custom_options_offset());
      ds.field("custom_options_size", &self.custom_options_size());
      ds.finish()
  }
}
